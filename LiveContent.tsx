    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (configRes.data && configRes.data.length > 0) {
            ...
            const newSiteConfig = { ...SITE_CONFIG_DEFAULT }; // Deep copy simple car objet simple
            
            // Deep copy manuelle pour l'objet imbriqué invoice pour éviter les mutations
        ...
        // Si au moins une requête a réussi, on considère le mode live actif
        setUsingLive(true);
